                ...
                @foreach ($pacients as $pacient)
                        <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        <a href="{{ route('patients.show', $pacient->id) }}" class="text-blue-600 dark:text-blue-400 hover:underline">
                                                {{ __('Visualizar') }}
                                        </a>
                                        <a href="{{ route('patients.edit', $pacient->id) }}" class="text-yellow-600 dark:text-yellow-400 hover:underline">
                                                {{ __('Editar') }}
                                        </a>
                                </td>
                        </tr>
